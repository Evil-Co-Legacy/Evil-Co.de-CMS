...
class DynamicPageManager {
	...
	public function getCache() {
		WCF::getCache()->addResource('dynamicPages-'.$this->host->hostID, WCF_DIR.'cache/cache.dynamicPages-'.$this->host->hostID.'.php', WCF_DIR.'lib/system/cache/CacheBuilderDynamicPages.class.php');
