...
<div class="mainHeadline">
	<img src="{@RELATIVE_WCF_DIR}icon/filemanagerL.png" alt="" />
		...
		<div class="largeButtons">
			<ul>
				{if $this->user->getPermission('admin.content.cms.filemanager.canUploadFiles')}
					<li>
						<a href="index.php?form=FilemanagerUpload&amp;packageID={@PACKAGE_ID}{@SID_ARG_2ND}" title="{lang}cms.filemanager.upload.title{/lang}"><img src="{@RELATIVE_WCF_DIR}icon/filemanagerUploadM.png" alt="" /> <span>{lang}cms.filemanager.upload.title{/lang}</span></a>
					</li>
				{/if}
