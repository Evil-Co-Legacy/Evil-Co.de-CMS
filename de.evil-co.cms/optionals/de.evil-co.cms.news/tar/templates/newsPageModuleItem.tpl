{if !$item->isDeleted && $item->isPublic || $item->isDeleted && $this->user->getPermission('user.cms.news.canSeeDeletedItems') && !$item->isPublic && $this->user->getPermission('user.cms.news.canSeeDisabledItems') || !$item->isDeleted && !$item->isPublic && $this->user->getPermission('user.cms.news.canSeeDisabledItems') || $item->isDeleted && $this->user->getPermission('user.cms.news.canSeeDeletedItems') && $item->isPublic}
